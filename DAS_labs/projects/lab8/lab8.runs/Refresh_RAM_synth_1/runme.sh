...
HD_PWD='C:/Users/Danil/Downloads/DAS_labs/projects/lab8/lab8.runs/Refresh_RAM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Refresh_RAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Refresh_RAM.tcl
